...
function cards() {
    ...
    (0,_services_sevices__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3000/menu')
        .then(data => {
...
window.addEventListener('DOMContentLoaded', function() {
      ...
      (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2026-05-04');
